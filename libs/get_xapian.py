...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-10855.tgz',
     'xapian-core.tgz',
     'c1b29ad3e815f477b1887066d61120efeb3d664e',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-10855.tgz',
     'xapian-bindings.tgz',
     '63b28828276301ce5ee145c3972c5a64d802c86a',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-10855.tgz',
     'win32msvc.tgz',
     '9b95184fa86876d71e740548b5eb8682628aa1eb',
     'xapian-core/win32',
    ),
)
