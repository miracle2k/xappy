...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-10853.tgz',
     'xapian-core.tgz',
     '2d2a2e7bb9b8b8a656440e70977e8ab9c5dc2f50',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-10853.tgz',
     'xapian-bindings.tgz',
     'cc56f94c19ccdbfa3af672741d57bbbba54112ad',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-10853.tgz',
     'win32msvc.tgz',
     '9516e462c8e8dd6fe768925a3590615c804d68e3',
     'xapian-core/win32',
    ),
)
