...
archives = (
    ...
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-12287.tgz',
     'xapian-bindings.tgz',
     'd529598fac845fac7f7c1e164201ed82398c3eec',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-12287.tgz',
     'win32msvc.tgz',
     'a8c08a641639adc2c5c1467ea75c5057758e072c',
     'xapian-core/win32',
    ),
    ('Xapian extras',
