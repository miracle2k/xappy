...
archives = [
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-13351.tgz',
     'xapian-core.tgz',
     '90ab87e99bced6d795bc822d5e22e220aa66cfed',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-13351.tgz',
     'xapian-bindings.tgz',
     '44deabfd265e645afee58f52341b44aeb2e43276',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-13351.tgz',
     'win32msvc.tgz',
     '20282165b08d7470edc8e15ed493c444ca614ed2',
     'xapian-core/win32',
    ),
    ('Xapian extras',
