...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-12664.tgz',
     'xapian-core.tgz',
     'ab2e18789a861ff78afb9d63aee4bb4eb45460c8',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-12664.tgz',
     'xapian-bindings.tgz',
     'b721a03b4a010064a097f92a936a745f8fd64a44',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-12664.tgz',
     'win32msvc.tgz',
     '624b0e7de67532f4da31de4ae46f0f429b6844a8',
     'xapian-core/win32',
    ),
    ('Xapian extras',
