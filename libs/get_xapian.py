...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-11368.tgz',
     'xapian-core.tgz',
     '21ecae4635b4cbb1511aa4e2a7a4f7a58a53675d',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-11368.tgz',
     'xapian-bindings.tgz',
     'bdf4b78cfa85a72fd356a260e133572f1f365a5b',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-11368.tgz',
     'win32msvc.tgz',
     'ec5d4b750fd5dd93f2b944bd81815ab552477a95',
     'xapian-core/win32',
    ),
)
