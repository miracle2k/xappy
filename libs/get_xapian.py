...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-12771.tgz',
     'xapian-core.tgz',
     '37b7ebc82103d69204d6ad2ac3ed28532adae033',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-12771.tgz',
     'xapian-bindings.tgz',
     '6b0d1cb23e03a5ba9df4816bf1d9e18507d8a318',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-12771.tgz',
     'win32msvc.tgz',
     '191a3d628fc01d87fc813f98dd1d09d52a35fdcc',
     'xapian-core/win32',
    ),
    ('Xapian extras',
