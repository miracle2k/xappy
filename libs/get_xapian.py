...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-10121.tgz',
     'xapian-core.tgz',
     'c3a02320e95de7fd91cdf7c5347641987f39330d',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-10121.tgz',
     'xapian-bindings.tgz',
     'e251fbdd8340a1f8fcdf32dce9cd4c1d0f9fd035',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-10121.tgz',
     'win32msvc.tgz',
     'ecf183fe1b4f450fad1b21f84aacc6fd1bee3dff',
     'xapian-core/win32',
    ),
)
