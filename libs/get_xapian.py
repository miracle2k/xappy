...
archives = [
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-13808.tgz',
     'xapian-core.tgz',
    '0191b276206c473ac0ccad22bfb7c2b287b27a81',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-13808.tgz',
     'xapian-bindings.tgz',
     'e341a98169c0b4021ad6b2464b60d56cd41ff9c6',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-13808.tgz',
     'win32msvc.tgz',
     '424d074b89afc2737e52b6389897514257df6618',
     'xapian-core/win32',
    ),
    ('Xapian extras',
