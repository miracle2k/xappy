...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-11831.tgz',
     'xapian-core.tgz',
     '924375e1f1a78c78b391907f79a678717870abee',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-11831.tgz',
     'xapian-bindings.tgz',
     'a2de923940e5cebcae174a23c448bf1b9cfb6713',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-11831.tgz',
     'win32msvc.tgz',
     '32705b90c346fec914370ef619fda194e36815cf',
     'xapian-core/win32',
    ),
)
