...
archives = (
    ...
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-11060.tgz',
     'xapian-bindings.tgz',
     '0279746901795c089e503f8aa64669bccc92d09b',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-11060.tgz',
     'win32msvc.tgz',
     '9ce9b8f656bafcfe02d283df4e88de5e8320a106',
     'xapian-core/win32',
    ),
)
