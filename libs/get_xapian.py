...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-9966.tgz',
     'xapian-core.tgz',
     'a0b74296cc58dff45c2098cb2d0fcd7792de61c1',
     (),
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-9966.tgz',
     'xapian-bindings.tgz',
     '14445b795caaf4b0f22b6bac1649d0b3898e2ba0',
     (),
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-9966.tgz',
     'win32msvc.tgz',
     '48ac176fa738d4117a7d8f3cfdf4af12bb01c09f',
     (),
    ),
)
