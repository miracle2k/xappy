...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-12324.tgz',
     'xapian-core.tgz',
     'ac246a50656869b6ea5b50d2c932477c98aaa539',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-12324.tgz',
     'xapian-bindings.tgz',
     '67c73be7808c689d2761e3ba176edd0605c1041c',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-12324.tgz',
     'win32msvc.tgz',
     'badb435d583ffcc4806c133dce4daad2e8dff3c0',
     'xapian-core/win32',
    ),
    ('Xapian extras',
