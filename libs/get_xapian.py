...
archives = [
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-13711.tgz',
     'xapian-core.tgz',
     'b8f4db7e59a6b333452a774608e6e4285b318a8b',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-13711.tgz',
     'xapian-bindings.tgz',
     '2787c3329def41188bcca2e674cdee97255c1b5c',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-13711.tgz',
     'win32msvc.tgz',
     '0ad43504998f609ac087fad284d9e0fb339c57f6',
     'xapian-core/win32',
    ),
    ('Xapian extras',
