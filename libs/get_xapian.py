...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-12693.tgz',
     'xapian-core.tgz',
     '5ec73c6f41c58326b1bf98667497e3b52a020b5d',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-12693.tgz',
     'xapian-bindings.tgz',
     'e6fbe6ee885d5d0e2adcc84ac9a97842f1a143a3',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-12693.tgz',
     'win32msvc.tgz',
     'b53924609062d0b3c9535c9288af6dce53647075',
     'xapian-core/win32',
    ),
    ('Xapian extras',
