...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-10871.tgz',
     'xapian-core.tgz',
     '741b4f1b300024f74682417d59a19956697614d4',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-10871.tgz',
     'xapian-bindings.tgz',
     '30753c2a603560f6b0c3caf754782fa68f6f30c5',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-10871.tgz',
     'win32msvc.tgz',
     '79ef8b4cc67029c7fb346214dc61482254989d1e',
     'xapian-core/win32',
    ),
)
