...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-10093.tgz',
     'xapian-core.tgz',
     '3bfdf1a369941801c611053f34ddc35494c17759',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-10093.tgz',
     'xapian-bindings.tgz',
     '2c22cd2475842142906bbc408bdeac946da82c22',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-10093.tgz',
     'win32msvc.tgz',
     '1f9e6bb763e39c324a37b6e655188f96192eca20',
     'xapian-core/win32',
    ),
)
