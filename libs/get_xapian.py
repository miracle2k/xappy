...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-10120.tgz',
     'xapian-core.tgz',
     '3fca384fe0c032645904426a6f2fe51933cd79e4',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-10120.tgz',
     'xapian-bindings.tgz',
     '6e8ee51c73ee1a9d8a616eb409a6232c5ac6d93d',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-10120.tgz',
     'win32msvc.tgz',
     '12fd46fad4a1bf986d91a94127961628d3a0e37e',
     'xapian-core/win32',
    ),
)
