...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-10840.tgz',
     'xapian-core.tgz',
     '168bfd897a9c439c923af6ec215324596c004c5a',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-10840.tgz',
     'xapian-bindings.tgz',
     '8a5278dccb0c575561177ea9ef8833b628d7c3f3',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-10840.tgz',
     'win32msvc.tgz',
     '66f3c6c741bc6c786b0813428d618ef0ca55d45b',
     'xapian-core/win32',
    ),
)
