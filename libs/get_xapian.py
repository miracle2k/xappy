...
archives = [
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-13666.tgz',
     'xapian-core.tgz',
     '029f833e9c86b18690d82981685d61e403a432f8',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-13666.tgz',
     'xapian-bindings.tgz',
     'f041fd1072e23f0268d0ecfcbb09700b6a5218b4',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-13666.tgz',
     'win32msvc.tgz',
     '71edb8110dfc8fd615bf9e90f482ced71751a1ad',
     'xapian-core/win32',
    ),
    ('Xapian extras',
