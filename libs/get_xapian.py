...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-11584.tgz',
     'xapian-core.tgz',
     'df3b75854a95aa2bc72359802423462d2abc28ff',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-11584.tgz',
     'xapian-bindings.tgz',
     '8f96679da71a75740ed2dede87653c10b302eda9',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-11584.tgz',
     'win32msvc.tgz',
     '46e30a93c1f0ccb1583d7c81baedf28debf0317e',
     'xapian-core/win32',
    ),
)
