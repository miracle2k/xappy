...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-11435.tgz',
     'xapian-core.tgz',
     'e7d0512dcfced9dabf40a4e777c288462450f005',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-11435.tgz',
     'xapian-bindings.tgz',
     '3a7a355f7a60dacc60cd2838cdf8743c363c63c5',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-11435.tgz',
     'win32msvc.tgz',
     'a9cf69c3c121d26b4274867b35b50a77b63d982b',
     'xapian-core/win32',
    ),
)
