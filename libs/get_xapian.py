...
archives = [
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-14062.tgz',
     'xapian-core.tgz',
     '3ebfa9d9761dfc86a98df8ff5257da07b7c22d75',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-14062.tgz',
     'xapian-bindings.tgz',
     '916375b81d08f3126f1752333232fbdf69341faa',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-14062.tgz',
     'win32msvc.tgz',
     'cbbed91f282a8517e70cfdbfa16ebe06b722a8e3',
     'xapian-core/win32',
    ),
    ('Xapian extras',
