...
archives = [
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-13351a.tgz',
     'xapian-core.tgz',
     'e08f02f9a04ec5a585b5a6a6171ed725f6387481',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-13351a.tgz',
     'xapian-bindings.tgz',
     'e581889662ab49862adcd7768d3c8c398da8bce3',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-13351a.tgz',
     'win32msvc.tgz',
     '723c35692116ccf221b3da8f63cb962bd0856e61',
     'xapian-core/win32',
    ),
    ('Xapian extras',
