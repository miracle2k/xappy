...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-11823.tgz',
     'xapian-core.tgz',
     'bbb2f8b5e8889ceb854cc08409d11f5b90466558',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-11823.tgz',
     'xapian-bindings.tgz',
     'd352ace70a42b236191f93f6faeec1bb2013f16a',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-11823.tgz',
     'win32msvc.tgz',
     'df017fc6368c9dc8d0ede4a8177b73e478e86fb5',
     'xapian-core/win32',
    ),
)
