...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-10844.tgz',
     'xapian-core.tgz',
     '1ad039c5e62273652ce2caf1dd9e9d1efa778986',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-10844.tgz',
     'xapian-bindings.tgz',
     '8b0476983f2934c7f55792ca907eef68e9238326',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-10844.tgz',
     'win32msvc.tgz',
     '3c6b3bae10dbc2185fd5644a150e65e579c6acc6',
     'xapian-core/win32',
    ),
)
