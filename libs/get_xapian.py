...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-10854.tgz',
     'xapian-core.tgz',
     'cc14120800cba1d483264df97aef4075fb801211',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-10854.tgz',
     'xapian-bindings.tgz',
     'cba5fc4a08a0a044951ccc9c50357b433c984dc9',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-10854.tgz',
     'win32msvc.tgz',
     'c4ab63ff63e458ee896faf6f1ce88edf9c4c0b44',
     'xapian-core/win32',
    ),
)
