...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-10817.tgz',
     'xapian-core.tgz',
     '29c79389605748901f4be721169335c286da4524',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-10817.tgz',
     'xapian-bindings.tgz',
     '990948589823f70a1549b122fe4e2cd72f15b169',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-10817.tgz',
     'win32msvc.tgz',
     'fbb5c30b7639b6a214cdcc21fde2bf826313df5e',
     'xapian-core/win32',
    ),
)
