...
archives = (
    ('Xapian core',
     'http://xappy.googlecode.com/files/xapian-core-11745.tgz',
     'xapian-core.tgz',
     'ee57f7e3353a539cf800742d4b832458c48ecdb3',
     '',
    ),
    ('Xapian bindings',
     'http://xappy.googlecode.com/files/xapian-bindings-11745.tgz',
     'xapian-bindings.tgz',
     'dfc71c632b772df6bdd9d0afa5ef8be2a565f537',
     '',
    ),
    ('Xapian win32 build system',
     'http://xappy.googlecode.com/files/win32msvc-11745.tgz',
     'win32msvc.tgz',
     '316748c80657945d280c93c85844f2822e7c284d',
     'xapian-core/win32',
    ),
)
